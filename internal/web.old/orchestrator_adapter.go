...
func (w *OrchestratorAdapter) ProcessUserRequest(ctx context.Context, request *application.OrchestratorRequest) (*application.OrchestratorResult, error) {
	return w.orchestratorService.ProcessUserRequest(ctx, request)
}
