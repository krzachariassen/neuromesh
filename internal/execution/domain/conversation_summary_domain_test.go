...
func TestNewConversationSummary(t *testing.T) {
	...
	cs, err := domain.NewConversationSummary(conversationID, planID, summary, userResult)
	...
	if cs.Status != domain.ConversationSummaryStatusCompleted {
		t.Errorf("Expected Status %s, got %s", domain.ConversationSummaryStatusCompleted, cs.Status)
	}
...
func TestNewConversationSummaryValidation(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			_, err := domain.NewConversationSummary(tt.conversationID, tt.planID, tt.summary, tt.userResult)
...
func TestConversationSummaryFromContentExtraction(t *testing.T) {
  ...
  "conversation_summary": "This is the user summary"
}`

	cs, err := domain.NewConversationSummaryFromContent(conversationID, planID, content)
...
func TestUpdateWithNewExecution(t *testing.T) {
	...
	cs, _ := domain.NewConversationSummary("conv-123", "plan-456", "Initial summary", "Initial result")
